# https://github.com/gkaramanis/tidytuesday/tree/master/2021/2021-week12
library(tidyverse)
...
# Save
ggsave("C:/Users/Hp/Documents/GitHub/Ferramentas_do_Tidyverse/ggplot/grafico_de_barras_no_ggplot.png", dpi = 320, width = 6, height = 9.5)
